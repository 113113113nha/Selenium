...
public class ContactPage extends AbstractPage {
	...
	public HomePage navigateToHomePage() {
		driver.get(URL);
		log4j.debug("-- clickElemt navigateToHomePage");
	...
	public ContactPage enterAddress(String address) {
		...
		log4j.debug("-- enterAddress " + address);
		return this;
	}
	...
	public ContactPage enterPostcode(String postcode) {
		...
		log4j.debug("-- enterPostcode " + postcode);
		return this;
	}
	...
	public ContactPage moveSliderBar(int value_percent) {
		...
		log4j.debug("-- moveSliderBar " + value_percent);
		return this;
	}
	...
	public ContactPage radioChoice(String option) {
		...
		log4j.debug("-- radioChoice " + option);
		return this;
	}
	...
	public ContactPage checkBoxOption(String option) {
		...
		log4j.debug("-- checkBoxOption " + option);
		return this;
	}
