...
public class HomePage extends AbstractPage {
	...
	public ContactPage navigateToContactPage() {
		contactLink.click();
		log4j.debug("-- clickElemt navigateToContactPage");
	...
	public AboutZooPage navigateToAboutZooPage() {
		aboutZooLink.click();
		log4j.debug("-- clickElemt navigateToAboutZooPage");
	...
	public AdoptionPage navigateToAdoptionPage() {
		adoptionLink.click();
		log4j.debug("-- clickElemt navigateToAdoptionPage");
	...
	public TermPage navigateToTermPage() {
		termLink.click();
		log4j.debug("-- clickElemt navigateToTermPage");
